      ...
      child: TextField(
        onChanged: onChange,
              ...
              decoration: InputDecoration(
                ...
                hintText: textHint,
                prefixIcon: textIcon == null ? Column() : Icon(textIcon, color: color),
            ...
            child: Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  border: InputBorder.none,
                  hintText: textHint,
                  suffixIcon: textIcon == null ? Column() : Icon(textIcon, color: color),
...
Widget appButton(
    {String buttonText,
    double buttonPadding, size,
    Color buttoncolor, btnColor, color,
    IconData icon,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 10.0),
            Text(buttonText,style: TextStyle(color: buttoncolor, fontSize: 15.0)),
          ],
        )
        // Center(
        //   child: Text(buttonText,style: TextStyle(color: buttoncolor, fontSize: 15.0)),
        // ),
      ),
    ),
  );
